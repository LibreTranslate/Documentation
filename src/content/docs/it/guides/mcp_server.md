...
LibreTranslate può fornire capacità di traduzione automatica agli agenti AI che supportano il protocollo [MCP](https://modelcontextprotocol.io/docs/getting-started/intro).
