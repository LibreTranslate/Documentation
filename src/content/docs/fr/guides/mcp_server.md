...
LibreTranslate peut fournir des capacités de traduction automatique aux agents IA qui prennent en charge le protocole [MCP](https://modelcontextprotocol.io/docs/getting-ting-started/intro).
