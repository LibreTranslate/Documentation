...
- [LibreTranslateClient for Firefox](https://addons.mozilla.org/en-US/firefox/addon/libretranslateclient/) another Firefox extension for translating with LibreTranslate
